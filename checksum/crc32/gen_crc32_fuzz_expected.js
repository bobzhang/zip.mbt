...
function crc32(bytes){
  let c=0xFFFFFFFF>>>0;
  for(let i=0;i<bytes.length;i++) c=(c>>>8)^T0[(c^bytes[i])&0xFF];
...
const lengths = [0,1,2,3,4,5,7,8,9,15,16,17,31,32,33,63,64,65,127,128,129,255,256,257,511,512,513,1024,1536,2048,3072,4096];
const crcs=[];
